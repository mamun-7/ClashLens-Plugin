...
{
	public class ExComplianceSettingsUIController : ComplianceSettingsUIController
	{
		#region Fields
		...
		public ExComplianceSettingsUIController(ClashSolverRequestId reqId, UIApplication uiApp)
		{
			...
			ComplianceSettingsController ins = m_Handler.Instance as ComplianceSettingsController;
